        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <div className="carousel-caption d-none d-md-block">
              <h1 className="carousel-title">Indonesia's<br/> Heroes History</h1>
    ...
    <div className="infos container mb-4 mb-md-2">
      ...
      <div className="socials text-right">
        <div className="row justify-content-between">
          <div className="col">
            <a className="d-block subtitle"><i className="ti-microphone pr-2" /> (021) 8811599</a>
            <a className="d-block subtitle"><i className="ti-email pr-2" /> 19104053@ittelkom-pwt.ac.id</a>
          </div>
        </div>
      </div>
    </div>
